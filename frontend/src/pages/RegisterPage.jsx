    ...
    <div className="min-h-screen bg-[#0b141c] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary/10 via-[#0b141c] to-[#0b141c]">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-[#b0b8d1]">
          Join to supercharge your learning
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[#141c24] py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-[#2d363e]/50">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-[#c3c6cf]">Full Name</label>
              <div className="mt-1">
                <input
                  name="full_name"
                  type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[#c3c6cf]">Username</label>
              <div className="mt-1">
                <input
                  name="username"
                  type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[#c3c6cf]">Confirm Password</label>
              <div className="mt-1">
                <input
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-[#002d6e] bg-primary hover:bg-[#d9e2ff] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-[#0b141c] transition-all duration-200 disabled:opacity-50"
              >
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#141c24] text-[#b0b8d1]">Already have an account?</span>
              </div>
            </div>

            <div className="mt-6 text-center">
              <Link to="/login" className="text-primary hover:text-[#d9e2ff] font-medium transition-colors">
                Sign in instead
              </Link>
            </div>
          </div>
